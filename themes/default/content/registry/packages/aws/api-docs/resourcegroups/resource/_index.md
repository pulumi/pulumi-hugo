...
<div>
<pulumi-choosable type="language" values="yaml">
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">aws:resourcegroups:Resource</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#grouparn_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Arn</a>
    ...
    <dd><p>The name or the ARN of the resource group to add resources to.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcearn_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Arn</a>
    ...
    <dd><p>The ARN of the resource to be added to the group.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcetype_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Type</a>
    ...
    <dd><p>The resource type of a resource, such as <code>AWS::EC2::Instance</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
