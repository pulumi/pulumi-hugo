...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#collectionid_csharp" style="color: inherit; text-decoration: inherit;">Collection<wbr>Id</a>
    ...
    <dd><p>The CIDR collection ID. See the <code>aws.route53.CidrCollection</code> resource for more details.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#locationname_csharp" style="color: inherit; text-decoration: inherit;">Location<wbr>Name</a>
    ...
    <dd><p>The CIDR collection location name. See the <code>aws.route53.CidrLocation</code> resource for more details. A <code>location_name</code> with an asterisk <code>&quot;*&quot;</code> can be used to create a default CIDR record. <code>collection_id</code> is still required for default record.</p>
</dd></dl>
</pulumi-choosable>
</div>
