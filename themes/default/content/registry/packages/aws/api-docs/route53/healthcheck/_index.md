...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fqdn_csharp" style="color: inherit; text-decoration: inherit;">Fqdn</a>
    ...
    <dd><p>The fully qualified domain name of the endpoint to be checked. If a value is set for <code>ip_address</code>, the value set for <code>fqdn</code> will be passed in the <code>Host</code> header.</p>
</dd><dt class="property-optional"
            title="Optional">
