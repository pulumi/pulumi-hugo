...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#principaltype_csharp" style="color: inherit; text-decoration: inherit;">Principal<wbr>Type</a>
    ...
    <dd><p>Principal type. Setting this argument empty (e.g., <code>principal_type = &quot;&quot;</code>) will result in an error. Valid values are <code>IAM</code> and <code>IAM_PATTERN</code>. Default is <code>IAM</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
