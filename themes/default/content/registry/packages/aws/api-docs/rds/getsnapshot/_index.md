...
copied or restored by any AWS account, otherwise set this value to false. The default is <code>false</code>.
<code>tags</code> - (Optional) Mapping of tags, each pair of which must exactly match
