...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#sourcetype_csharp" style="color: inherit; text-decoration: inherit;">Source<wbr>Type</a>
    ...
    <dd><p>The type of source that will be generating the events. Valid options are <code>db-instance</code>, <code>db-security-group</code>, <code>db-parameter-group</code>, <code>db-snapshot</code>, <code>db-cluster</code>, <code>db-cluster-snapshot</code>, or <code>db-proxy</code>. If not set, all sources will be subscribed to.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="tags_csharp">
