...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#provisionedconcurrency_csharp" style="color: inherit; text-decoration: inherit;">Provisioned<wbr>Concurrency</a>
    ...
    <dd><p>The amount of provisioned concurrency to allocate for the serverless endpoint. Should be less than or equal to <code>max_concurrency</code>. Valid values are between <code>1</code> and <code>200</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
