...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#gatewayid_csharp" style="color: inherit; text-decoration: inherit;">Gateway<wbr>Id</a>
    ...
    <dd><p>Identifier of a VPC internet gateway, virtual private gateway, or <code>local</code>. <code>local</code> routes cannot be created but can be adopted or imported. See the example above.</p>
</dd><dt class="property-optional"
            title="Optional">
