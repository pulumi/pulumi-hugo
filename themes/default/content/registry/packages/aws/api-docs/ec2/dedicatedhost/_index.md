...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#assetid_csharp" style="color: inherit; text-decoration: inherit;">Asset<wbr>Id</a>
    ...
    <dd><p>The ID of the Outpost hardware asset on which to allocate the Dedicated Hosts. This parameter is supported only if you specify OutpostArn. If you are allocating the Dedicated Hosts in a Region, omit this parameter.</p>
