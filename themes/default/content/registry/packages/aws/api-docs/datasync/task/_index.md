...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#objecttags_csharp" style="color: inherit; text-decoration: inherit;">Object<wbr>Tags</a>
    ...
    <dd><p>Specifies whether object tags are maintained when transferring between object storage systems. If you want your DataSync task to ignore object tags, specify the NONE value. Valid values: <code>PRESERVE</code>, <code>NONE</code>. Default value: <code>PRESERVE</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
