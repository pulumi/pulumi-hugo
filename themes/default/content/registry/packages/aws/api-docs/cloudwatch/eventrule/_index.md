...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nameprefix_csharp" style="color: inherit; text-decoration: inherit;">Name<wbr>Prefix</a>
    ...
    <dd><p>Creates a unique name beginning with the specified prefix. Conflicts with <code>name</code>. <strong>Note</strong>: Due to the length of the generated suffix, must be 38 characters or less.</p>
</dd><dt class="property-optional"
            title="Optional">
