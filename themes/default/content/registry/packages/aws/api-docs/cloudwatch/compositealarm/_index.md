...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#actionssuppressor_csharp" style="color: inherit; text-decoration: inherit;">Actions<wbr>Suppressor</a>
    ...
    <dd><p>Actions will be suppressed if the suppressor alarm is in the ALARM state.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<h4 id="compositealarmactionssuppressor">Composite<wbr>Alarm<wbr>Actions<wbr>Suppressor</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#alarm_csharp" style="color: inherit; text-decoration: inherit;">Alarm</a>
    ...
    <dd><p>Can be an AlarmName or an Amazon Resource Name (ARN) from an existing alarm.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#extensionperiod_csharp" style="color: inherit; text-decoration: inherit;">Extension<wbr>Period</a>
    ...
    <dd><p>The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the <code>ALARM</code> state. After this time, the composite alarm performs its actions.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#waitperiod_csharp" style="color: inherit; text-decoration: inherit;">Wait<wbr>Period</a>
    ...
    <dd><p>The maximum time in seconds that the composite alarm waits for the suppressor alarm to go into the <code>ALARM</code> state. After this time, the composite alarm performs its actions.</p>
</dd></dl>
</pulumi-choosable>
</div>
