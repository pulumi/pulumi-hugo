...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#coolingperiod_csharp" style="color: inherit; text-decoration: inherit;">Cooling<wbr>Period</a>
    ...
    <dd><p>Specifies the number of days that user data in a volume must remain inactive before it is considered &quot;cold&quot; and moved to the capacity pool. Used with <code>AUTO</code> and <code>SNAPSHOT_ONLY</code> tiering policies only. Valid values are whole numbers between 2 and 183. Default values are 31 days for <code>AUTO</code> and 2 days for <code>SNAPSHOT_ONLY</code>.</p>
</dd><dt class="property-optional"
            title="Optional">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
