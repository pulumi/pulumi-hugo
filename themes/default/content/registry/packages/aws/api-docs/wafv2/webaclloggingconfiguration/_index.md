...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
    ...
    <dd><p>Action setting that a log record must contain in order to meet the condition. Valid values for <code>action</code> are <code>ALLOW</code>, <code>BLOCK</code>, and <code>COUNT</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#labelname_csharp" style="color: inherit; text-decoration: inherit;">Label<wbr>Name</a>
    ...
    <dd><p>Name of the label that a log record must contain in order to meet the condition. It must be a fully qualified label name, which includes a prefix, optional namespaces, and the label name itself. The prefix identifies the rule group or web ACL context of the rule that added the label.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#method_csharp" style="color: inherit; text-decoration: inherit;">Method</a>
    ...
    <dd><p>HTTP method to be redacted. It must be specified as an empty configuration block <code>{}</code>. The method indicates the type of operation that the request is asking the origin to perform.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#querystring_csharp" style="color: inherit; text-decoration: inherit;">Query<wbr>String</a>
    ...
    <dd><p>Whether to redact the query string. It must be specified as an empty configuration block <code>{}</code>. The query string is the part of a URL that appears after a <code>?</code> character, if any.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#singleheader_csharp" style="color: inherit; text-decoration: inherit;">Single<wbr>Header</a>
    ...
    <dd><p>&quot;single_header&quot; refers to the redaction of a single header. For more information, please see the details below under Single Header.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#uripath_csharp" style="color: inherit; text-decoration: inherit;">Uri<wbr>Path</a>
    ...
    <dd><p>Configuration block that redacts the request URI path. It should be specified as an empty configuration block <code>{}</code>. The URI path is the part of a web request that identifies a resource, such as <code>/images/daily-ad.jpg</code>.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Name of the query header to redact. This setting must be provided in lowercase characters.</p>
</dd></dl>
</pulumi-choosable>
</div>
