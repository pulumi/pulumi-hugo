...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#skipdestroy_csharp" style="color: inherit; text-decoration: inherit;">Skip<wbr>Destroy</a>
    ...
    <dd><p>Whether to retain the provisoned concurrency configuration upon destruction. Defaults to <code>false</code>. If set to <code>true</code>, the resource in simply removed from state instead.</p>
</dd></dl>
</pulumi-choosable>
</div>
