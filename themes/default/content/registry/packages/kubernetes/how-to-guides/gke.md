...
apps on your new cluster, see [Kubernetes Tutorial: Getting Started With Pulumi]([App Rollout via ConfigMap Data Change](/registry/packages/kubernetes/how-to-guides/kubernetes-ts-configmap-rollout/).
