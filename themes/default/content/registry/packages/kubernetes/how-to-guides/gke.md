...
1. Configure GCP Auth
    ...
    * Login using `gcloud`
    ...
    > account setting, such as in CI/CD, please [follow instructions to configure your service account](https://www.pulumi.com/registry/packages/gcp/service-account/). The
