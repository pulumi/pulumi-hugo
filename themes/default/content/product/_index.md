          ...
          features:
            - title: Multiple deployment options
              ...
              description: |
                ...
                [Automation API](/products/automation-api/), or through your [CI/CD process](/docs/guides/continuous-delivery/).

            - title: Deployments as Code
              icon: gear
              icon_color: salmon
              description: |
                Run deployments from your application code at runtime with [Automation API](/products/automation-api/). Create infrastructure APIs, custom platforms, and CLIs.
