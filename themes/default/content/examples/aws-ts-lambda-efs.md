...
meta_desc: "Examples of using Lambda + EFS"
metadata:
  id: aws-ts-lambda-efs
  title: "Using Amazon EFS with AWS Lambda"
  description: "Examples of using Lambda + EFS"
  url: https://github.com/pulumi/examples/tree/master/aws-ts-lambda-efs
  runtime: nodejs
  lastUpdate: 1683413741000
  duration: 344000
  resources:
  - pulumi:pulumi:Stack
...
summary: "This Pulumi example creates an AWS backend infrastructure to power a TypeScript Lambda function that uses Amazon Elastic File System (EFS) to store and retrieve data. It utilizes AWS services such as Lambda, S3 and CloudFormation as well as Pulumi&#x27;s infrastructure-as-code infrastructure management capabilities. Pulumi&#x27;s TypeScript APIs are used to define the desired cloud infrastructures for the Lambda function. The example serves a general use case of cloud-computing where the cloud infrastructure is managed and updated in code, rather than via a manual process."
---
