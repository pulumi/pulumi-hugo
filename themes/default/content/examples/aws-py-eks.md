...
meta_desc: "A minimal AWS Python EKS example cluster"
metadata:
  id: aws-py-eks
  title: "Amazon EKS Cluster"
  description: "A minimal AWS Python EKS example cluster"
  url: https://github.com/pulumi/examples/tree/master/aws-py-eks
  runtime: python
  lastUpdate: 1683413448000
  duration: 745000
  resources:
...
summary: "This Pulumi example creates a Kubernetes cluster in Amazon Web Services using Python. AWS is used as the cloud provider and Python is used as the programming language. Specifically, the example resources used include an EKS cluster, IAM Role and Policy, Security Group, and two Subnets. The example serves the general cloud-computing use case of deploying applications on Kubernetes clusters."
---
