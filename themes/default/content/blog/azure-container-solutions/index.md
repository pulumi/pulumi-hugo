...
This tight integration with Azure’s many other services makes it likely to meet the needs of your application and extend it as needed, such as if you are introducing common architecture components like message queues and databases.
...
This situation even extends to the allowed languages that Azure App Service supports: If you’re developing your application in an unsupported language, you can’t use the service.
