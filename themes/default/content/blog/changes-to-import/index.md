...
To help you understand the changes we've made to help you on your journey, let's take a look at some side-by-side examples of how `pulumi import` used to work vs. what we're releasing today in (3.26)[https://github.com/pulumi/pulumi/releases/tag/v3.26.0].
