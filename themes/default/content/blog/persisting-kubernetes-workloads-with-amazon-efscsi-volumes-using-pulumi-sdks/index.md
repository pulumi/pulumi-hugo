...
{{% notes type="warning" %}}
Some parts of this blog post are out-of-date. As an alternative, please refer to the [EFS CSI Helm Chart](https://github.com/kubernetes-sigs/aws-efs-csi-driver/tree/master/charts/aws-efs-csi-driver) and Pulumi's support for [deploying helm charts](/docs/using-pulumi/adopting-pulumi/migrating-to-pulumi/from_kubernetes#provisioning-a-helm-chart)
{{% /notes %}}
