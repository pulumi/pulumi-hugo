...
[Install Pulumi CLI](/docs/get-started/) and set up your [AWS credentials](/docs/clouds/aws/get-started/). Initialize a new [Pulumi project](/docs/intro/concepts/project/) from available templates. We use `aws-typescript` template here to install all library dependencies.
