...
The [Pulumi Service Provider](/registry/packages/pulumiservice/) can be used in any Pulumi language, TypeScript, Python, Go, .NET, Java and YAML. It supports configuration of [Teams](/docs/intro/pulumi-cloud/teams/), [Access Tokens](/docs/intro/pulumi-cloud/accounts/), [Stack Tags](/docs/cli/pulumi_stack_tag/) and [Webhooks](/docs/intro/pulumi-cloud/webhooks/) using infrastructure as code.
