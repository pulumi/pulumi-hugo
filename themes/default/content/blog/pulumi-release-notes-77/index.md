...
You can now specify a stack when using [`pulumi destroy`](/docs/cli/pulumi_destroy) while outside of the project directory.
...
Learn more about the permissions in the [Billing Manager blog post](/blog/billing-managers/) and the [Billing Manager documentation](/docs/pulumi-cloud/billing-managers/).
