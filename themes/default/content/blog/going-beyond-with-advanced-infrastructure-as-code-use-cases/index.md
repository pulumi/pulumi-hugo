...
Pulumi Cloud is available for unlimited free usage, has a free tier for teams and offers advanced editions for larger teams and enterprises. Pulumi’s SDK is fully open source and can be used without the service (read more about that here), but the cloud service is the easiest, most secure and most reliable way to use Pulumi Cloud.
