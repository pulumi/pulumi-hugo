...
The alternative is to use an [infrastructure as code]({{< relref "/what-is/infrastructure-as-code" />}}) tool to automate building and deploying cloud resources. This article demonstrates how to provision an Azure Synapse workspace using Pulumi and general-purpose programming languages like Python and C#.
