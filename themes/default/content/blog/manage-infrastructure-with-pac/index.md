...
2. [Running a Policy Pack locally]({{< relref "/docs/guides/policy-as-code/get-started#running-locally" >}}) to speed up development and testing of policies. Validate infrastructure before deployment.
...
4. [Apply a Policy Pack]({{< relref "/docs/guides/policy-as-code/get-started#enforcing-a-policy-pack" >}}) across an organization to validate all the infrastructure deployed
