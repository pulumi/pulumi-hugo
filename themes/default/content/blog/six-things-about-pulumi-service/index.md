...
While you can create, edit, and remove stack tags using the Pulumi CLI (see [`pulumi stack tag`](/docs/cli/pulumi_stack_tag)), you can also do so in the Pulumi Console:
