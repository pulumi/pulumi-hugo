...
Let's walk through an example. We'll author a `Message` component which accepts a message as input and provides a `getMessage` method that accepts a recipient name and returns the message customized for the recipient. To get started authoring a component package, refer to the [package]({{<relref "/docs/guides/pulumi-packages">}}) documentation.
...
Altogether our schema looks like:
...
We can implement the component in TypeScript/JavaScript, Python, or Go, and make it available to any Pulumi language.
