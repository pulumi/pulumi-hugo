...
{{% notes type="info" %}}
Use the [retainOnDelete option]({{< relref "docs/intro/concepts/resources/options/retainOnDelete.md">}}) if you don't want to delete the shared resource when a stack is destroyed.
{{% /notes %}}
