...
We [now support](https://github.com/pulumi/pulumi/releases/tag/v3.25.0) a new resource option [retain on delete](/docs/concepts/resources/options/retainondelete/) that allows you to specify this case to the engine.
...
Read more about retain on delete in our [docs](/docs/concepts/resources/options/retainondelete/). Let us know how you get on with this new feature at our community [Slack](https://slack.pulumi.com/)!
