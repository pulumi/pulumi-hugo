...
Support for the new `pulumi convert --from terraform` command is available today. We are actively addressing issues, reducing the number of emitted TODOs, and improving the overall quality of the converted code.
