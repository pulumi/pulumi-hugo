...
contents via [`pulumi stack export`](/docs/cli/pulumi_stack_export), you would not be able to recover
the data.
...
When you create a new stack using [pulumi stack init](/docs/cli/pulumi_stack_init/), you can optionally
