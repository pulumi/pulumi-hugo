...
In [AWS Advanced Networking Part 1](https://pulumi.com/blog/advanced-aws-networking-part-1/):

1. Discussed the benefits of a hub-and-spoke network architecture with centralized egress.
...
1. Defined our inspection VPC as a Pulumi [component resource](https://www.pulumi.com/docs/intro/concepts/resources/components/).

Now, to finish the architecture, we will need to:
