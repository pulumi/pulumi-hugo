...
Cloud resources, regardless of the provider, come with various properties that define their behavior, performance, location, and more. With Pulumi Cloud Property Search, you can now search resources based on these properties. Whether you're trying to find resources running in a specific region, instances with a particular tag, or databases running a certain engine version, searching over properties with Pulumi Cloud streamlines and simplifies your tasks.
