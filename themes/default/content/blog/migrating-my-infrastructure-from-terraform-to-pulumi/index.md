...
You can check the [API reference](https://www.pulumi.com/registry/aws/s3/bucket/) for details on how to import each specific resource. The instructions on how to do it is usually at the bottom of the reference page for each resource type.
