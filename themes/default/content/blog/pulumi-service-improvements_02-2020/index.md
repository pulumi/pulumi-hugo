...
based on stack tags. For example, you can now use filters to rapidly add stacks to [Pulumi teams](/docs/pulumi-cloud/teams/).
...
using [teams](/docs/pulumi-cloud/teams/). But a common problem we've heard from people in large organizations
