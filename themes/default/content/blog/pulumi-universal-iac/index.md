...
Today, we released a new [Pulumi provider for the Pulumi Service](/registry/packages/pulumiservice/), supporting configuration of [Teams](/docs/intro/pulumi-cloud/teams/), [Access Tokens](https://www.pulumi.com/docs/intro/pulumi-cloud/accounts/#access-tokens), [Stack Tags](/docs/reference/cli/pulumi_stack_tag/) and [Webhooks](/docs/intro/pulumi-cloud/webhooks/) using infrastructure as code.
