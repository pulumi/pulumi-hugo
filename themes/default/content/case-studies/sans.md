---
title: Streamlining Application and Infrastructure Delivery at SANS
description: |
    Using Pulumi, SANS Lbs greatly simplified their architecture and created a better user experience for SANS Labs instructors and students.
meta_desc: |
    Using Pulumi, SANS Lbs greatly simplified their architecture and created a better user experience for SANS Labs instructors and students.
...
exec_summary: |
    The DevOps team at SANS Institute, which provides cybersecurity training and certification, uses Pulumi to streamline delivering applications and infrastructure through CI/CD processes for many business units at SANS. The organization implemented Pulumi with TypeScript to replace its brittle, inflexible workflows that had been stitched together with Bash scripts, AWS Lambda functions, and infrastructure tools that use domain-specific languages (DSLs). By transitioning to Pulumi for building and deploying their cloud applications, they’ve reduced deployment times, simplified architectures, improved code quality, and ultimately created a better experience for their end customers.
...
<img class="block mx-auto md:max-w-4xl my-8" src="/images/case-studies/sans-game-server-diagram.png" alt="SANS Game Server Architecture">
...
Chris and Tyler both felt that using programming languages for infrastructure made code quality much better across all projects.
...
<img class="block mx-auto md:max-w-4xl my-8" src="/images/case-studies/sans-gitops-diagram.png" alt="SANS GitOps Architecture">
