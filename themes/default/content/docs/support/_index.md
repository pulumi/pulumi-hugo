...
<div class="md:flex flex-row mt-6 mb-6">
    <div class="w-1/2 border-solid border-t-2 border-gray-200">
        <h3 class="no-anchor pt-4"><a href="{{< relref "/docs/troubleshooting" >}}"><i class="fas fa-user-friends pr-2"></i>Troubleshooting</a></h3>
    ...
    <div class="w-1/2 border-solid ml-4 border-t-2 border-gray-200">
        <h3 class="no-anchor pt-4"><a href="{{< relref "/docs/troubleshooting/faq" >}}"><i class="fas fa-comment-alt pr-2"></i>FAQ</a></h3>
