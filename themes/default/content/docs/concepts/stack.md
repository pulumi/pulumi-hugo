...
Tags can be deleted by running [`pulumi stack tag rm <name>`](/docs/cli/pulumi_stack_tag_rm).
...
From the CLI, you can then use [`pulumi stack output url`](/docs/cli/pulumi_stack_output) to get the value and incorporate into other scripts or tools.
