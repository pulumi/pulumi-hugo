...
Now use all of these cloud resources, and a local `FileAsset` resource, to upload `index.html` into your storage container. Add the following at the end of the file (right after enabling the static website support)
