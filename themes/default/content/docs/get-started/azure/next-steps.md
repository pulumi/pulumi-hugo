...
{{< get-started-next-step path="/registry/packages/azure-native/how-to-guides" label="Explore How-to Guides" >}}
...
{{< get-started-next-step path="/blog/tag/azure" label="Read the Pulumi Blog" >}}
