...
{{< get-started-next-step path="/registry/packages/gcp/how-to-guides" label="Explore How-to Guides" >}}
...
{{< get-started-next-step path="/blog/tag/google-cloud" label="Read the Pulumi Blog" >}}
