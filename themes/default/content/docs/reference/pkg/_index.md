...
{{< resource-providers "aiven,auth0,azuread,azuredevops,consul,docker,kafka,keycloak,kong,mailgun,okta,pagerduty,rabbitmq,rancher2,snowflake,spotinst,splunk,vault,venafi,opsgenie,rke,confluent,nomad,minio" >}}
