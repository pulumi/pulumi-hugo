...
Sensitive secrets such as the [Pulumi Access Token]({{< relref "/docs/intro/pulumi-service/accounts/#access-tokens" >}}), the cloud provider credentials, or even your VCS credentials
