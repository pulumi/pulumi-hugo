...
You can get your [Pulumi access token](/docs/intro/pulumi-cloud/accounts#access-tokens) from [https://app.pulumi.com/account/tokens](https://app.pulumi.com/account/tokens). Here's an example snippet of how you can use the task in your pipeline yaml.
