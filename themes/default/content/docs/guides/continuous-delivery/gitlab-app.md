...
* If you are integrating a GitLab project that is under a group, [add an organization]({{< relref "/docs/intro/console/organizations/#creating-an-organization" >}})
  in Pulumi.
  * After you add the organization ensure that it uses GitLab as its identity provider. You may [change your org identity]({{< relref "/docs/intro/console/organizations/#changing-identity-providers" >}})
    provider in the Pulumi Console after the organization has been added.
