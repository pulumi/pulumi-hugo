...
* [Create a Pulumi access token]({{< relref "/docs/intro/pulumi-service/access-tokens" >}}) using the account that you would like the merge request notes to be posted as. Save this token as we will use this momentarily in a following step.
