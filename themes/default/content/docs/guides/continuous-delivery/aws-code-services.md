...
an update. You can create a new [Pulumi access token]({{< relref "/docs/intro/pulumi-service/accounts/#access-tokens" >}}) specifically for your CloudBuild project on
