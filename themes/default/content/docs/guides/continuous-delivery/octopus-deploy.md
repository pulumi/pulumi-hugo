---
title: Integrating Octopus Deploy | CI/CD
...
You can create a new stack by running [`pulumi stack init`](/docs/reference/cli/pulumi_stack_init) from the folder containing the `Pulumi.yaml` file.
