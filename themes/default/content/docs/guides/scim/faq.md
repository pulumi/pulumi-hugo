...
Yes. In addition to the SCIM-managed teams, one can also configure and manage Pulumi-local teams in the Pulumi Service. See [Teams]({{< relref "/docs/intro/console/teams" >}}) for how to configure teams in the Pulumi Service.  
