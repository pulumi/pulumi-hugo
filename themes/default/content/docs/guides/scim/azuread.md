...
To enable provisioning of Azure AD groups to Pulumi Cloud, click **Edit Provisioning** and then click the **Provision Azure Active Directory Groups** setting under the **Mappings**
