...
- `displayName`: the friendly name for your package that's displayed on the browse page of the Registry; this name should match the title of the `_index.md`file.
