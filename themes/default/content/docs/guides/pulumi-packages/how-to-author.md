...
> API docs for your package will be automatically generated by our automated pipelines at the time of building the registry site.
> So there is no action for package authors for making sure API docs are generated other than making sure your package repository has
> the right schema.json (or yaml) and that the metadata file for your package points to the correct schema file.
