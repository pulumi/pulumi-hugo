...
| [AWS Auto Scaling](https://aws.amazon.com/autoscaling) | Automatic scaling policies | [User Guide](autoscaling) | [autoscaling](/registry/packages/aws/api-docs/autoscaling) |
...
| [Amazon CloudWatch](https://aws.amazon.com/cloudwatch/) | Application and infrastructure monitoring | [User Guide](cloudwatch) | [cloudwatch](/registry/packages/aws/api-docs/cloudwatch) |
...
| [Amazon Elastic Container Registry (ECR)](https://aws.amazon.com/ecr/) | Private container registries | [User Guide](ecr) | [ecr](/registry/packages/aws/api-docs/ecr) |
| [Amazon Elastic Container Service (ECS)](https://aws.amazon.com/ecs/) | Run containerized apps | [User Guide](ecs) | [ecs](/registry/packages/aws/api-docs/ecs) |
...
| [Amazon Elastic Kubernetes Service (EKS)](https://aws.amazon.com/eks/) | Managed Kubernetes service | [User Guide](eks) | [eks](/registry/packages/aws/api-docs/eks) |
...
| [AWS Elastic Load Balancing (ELB)](https://aws.amazon.com/elasticloadbalancing/) | Scale across many instances | [User Guide](elb) | [lb](/registry/packages/aws/api-docs/lb) |
...
| [AWS Identity and Access Management (IAM)](https://aws.amazon.com/iam/) | Securely manage access | [User Guide](iam) | [iam](/registry/packages/aws/api-docs/iam) |
...
| [AWS Lambda](https://aws.amazon.com/lambda/) | Run serverless code | [User Guide](lambda) | [lambda](/registry/packages/aws/api-docs/lambda) |
...
| [Amazon Virtual Private Cloud (VPC)](https://aws.amazon.com/vpc/) | Secure, isolated networks | [User Guide](vpc) | [vpc](/docs/reference/pkg/nodejs/pulumi/awsx/ec2#Vpc) |
