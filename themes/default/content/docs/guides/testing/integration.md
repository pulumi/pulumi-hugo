...
- [NodeJS tests](https://github.com/pulumi/pulumi/blob/master/sdk/nodejs/tests/product/automation-api/localWorkspace.spec.ts)
- [Go tests](https://github.com/pulumi/pulumi/blob/master/sdk/go/auto/local_workspace_test.go)
- [Python tests](https://github.com/pulumi/pulumi/blob/master/sdk/python/lib/test/product/automation-api/test_local_workspace.py)
