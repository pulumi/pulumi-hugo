...
<br>
Yes, Pulumi ESC is served using the same high-availability infrastructure as the rest of Pulumi Cloud. This service is currently in preview, meaning that we are rapidly iterating and improving its feature set. It is unlikely that we will make any breaking changes. Should we introduce a new API, we are dedicated to ensuring optimal compatibility to prevent any interruptions to your infrastructure.
