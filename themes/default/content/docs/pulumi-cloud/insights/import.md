...
If you've never used Pulumi with AWS before we recommend you start first with the [Get Started with AWS](https://www.pulumi.com/docs/clouds/aws/get-started/) guide that helps you configure credentials and install dependencies.
...
If you've never used Pulumi with Azure before we recommend you start first with the [Get Started with Azure](https://www.pulumi.com/docs/clouds/azure/get-started/) guide that helps you configure credentials and install dependencies.
