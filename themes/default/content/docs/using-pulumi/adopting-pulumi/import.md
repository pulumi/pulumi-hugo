...
| `parent`     | `string`        | No       | The name of the [parent](/docs/concepts/resources/options/parent/) resource. The mentioned name must be present in the `nameTable`.     |
| `provider`   | `string`        | No       | The name of the [provider](/docs/concepts/resources/options/provider/) resource. The mentioned name must be present in the `nameTable`. |
| `version`    | `string`        | No       | The [version](/docs/concepts/resources/options/version/) of the provider to use.                                                        |
