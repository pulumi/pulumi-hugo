---
title: Multiple Azure Kubernetes Service (AKS) cluster deployments
meta_desc: Tutorial that demonstrates creating multiple Azure Kubernetes Service (AKS) clusters in different regions and with different node counts.
---

{{< github-buttons "azure-ts-aks-multicluster" "azure-py-aks-multicluster" "azure-go-aks-multicluster" "azure-cs-aks-multicluster" >}}
