...
- Azure API reports a list of supported API versions per resource and resource provider. We hold off promoting resources to new API versions until they are reported as supported as seen via the `az provider list` command.
