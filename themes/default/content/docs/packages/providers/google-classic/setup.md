...
{{% notes "info" %}}
If you are using Pulumi in an non-interactive setting (such as a CI/CD system) you will need to [configure and use a service account]({{< relref "/docs/cloud-providers/google/setup#setup-service-account" >}}) instead.
{{% /notes %}}
