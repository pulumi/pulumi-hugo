...
1. To preview and deploy changes, run `pulumi up` and select "yes."
    ...
    new EKS cluster takes between 10-15 minutes.
        ...
        +   │  ├─ pulumi:packages:kubernetes             helloworld-eks-k8s                  	create
        ...
        +   │  └─ pulumi:packages:kubernetes             helloworld-provider                 	create
        ...
        ...
        +   │  ├─ pulumi:packages:kubernetes             helloworld-eks-k8s                  	created
        ...
        +   │  └─ pulumi:packages:kubernetes             helloworld-provider                 	created
        ...
