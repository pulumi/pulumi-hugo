...
In addition to the step-by-step tutorials in this section, there are also many code examples for AWS that showcase how to use Pulumi with specific AWS services in a wide range of use cases. For a complete list, see [Examples]({{< relref "/docs/cloud-providers/aws/examples" >}}).
...
https://github.com/pulumi/pulumi-hugo/issues/new?title=New%20AWS%20Tutorial%20Request).
