---
title: Container Service on AWS | Pulumi Template
meta_desc: The Container Service template makes it easy to deploy a container serivce on AWS with Pulumi and Amazon Elastic Container Service (ECS).
meta_image: meta.png
