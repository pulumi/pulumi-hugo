...
deploy:
  title: Deploy
  description: |
    Deploy cloud applications and infrastructure faster and with confidence, using one shared approach for your entire team that works for day one and beyond.
  items:
  ...
  items:
    ...
    - title: Use engineering practices with infrastructure
      ...
      description: |
        ...
        practices—including modularity, testing, and CI/CD.
