...
main:
    ...
    description: |
        ...
        If you want to code along, you’ll need a [free Pulumi SaaS account](https://app.pulumi.com/signup/), [the Pulumi CLI](https://www.pulumi.com/docs/get-started/install), [.NET 6+](https://www.pulumi.com/docs/languages-sdks/dotnet/), and an Azure account (free tier is okay).
