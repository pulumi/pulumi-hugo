...
including all the required frontmatter parameters.
   ...
   ```zsh
   hugo new --kind blog-post themes/current/content/blog/my-new-post
   ```

   This will create a minimal post browsable at http://localhost:1313/blog/. You'll find the new
   post's source file at `themes/current/content/blog/my-new-post/_index.md` containing the set of
...
- [ ] As mentioned, use the Hugo blog-post generator instead of copying another post: `hugo new --kind blog-post themes/current/content/blog/my-new-post`
